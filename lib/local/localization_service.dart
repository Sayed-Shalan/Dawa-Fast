...
class LocalizationService extends Translations {
  ...
  static Locale? getCurrentLocale() {
    if(pref.currentLocal() == null){
      //TODO follow up device language
    // return locales[indexOf(Get.deviceLocale?.languageCode)]  ;
    return locales[1]  ;
    }
  ...
  static bool isRtl({String? lngCode}) {
    ...
    var deviceLocal = LocalizationService.locales[indexOf(Get.deviceLocale?.languageCode)];
